...
1. Open the notebook: **India Airlines Ticket Price Exploratory Analysis.ipynb**
2. Run cells step-by-step to view analysis and visualizations
3. Modify or extend the code to perform deeper analysis
